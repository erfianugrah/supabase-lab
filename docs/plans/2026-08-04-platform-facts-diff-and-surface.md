...
| ~~There is no region-catalogue endpoint; the creatable set is documentation-only~~ SUPERSEDED 2026-08-20: F04a's probes were name-guessed paths. The catalogue exists at `GET /v1/projects/available-regions?organization_slug=<slug>` (residency-facts R01, F04c; see the platform-facts RUNLOG correction) | F04, RAN 2026-08-04, same control idiom | The 2026-08-04 negative was wrong; you CAN discover. The name-guessing failure this row fell into is the one F05's enumerate-the-spec method exists to avoid |
